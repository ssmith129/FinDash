      ...
      >
        ...
        <Container>
          <section className="pt-0 pb-[40px]">
            ...
            <div className="mb-[20px] grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="w-full p-[24px] rounded-3xl border !border-Mborder-border-primary dark:!border-Mborder-border-primary-dark">
                ...
                <Link
                  ...
                  className="rounded-full inline-block text-center font-semibold text__14 py-[10px] px-[12px] cursor-pointer text-Mtext-text-secondary dark:text-Mtext-text-secondary-dark border !border-Mborder-border-primary dark:!border-Mborder-border-primary-dark"
                >
                  Withdraw
                </Link>
              </div>
              <div className="w-full p-[24px] rounded-3xl border !border-Mborder-border-primary dark:!border-Mborder-border-primary-dark">
                ...
                <Link
                  href={"/dashboard/my-wallet/scheduled-transfer/send"}
                  className="rounded-full inline-block text-center font-semibold text__14 text-white py-[10px] px-[16px] bg-Mbrand-brand-primary !border-MPrimary btnClass cursor-pointer shadow-[0px_4px_20px_rgba(1,_122,_255,_0.3),_inset_0px_1px_0px_rgba(255,_255,_255,_0.4),_inset_0px_-4px_13px_rgba(0,_0,_0,_0.2)]"
                >
            ...
            <div className="p-[24px] border !border-Mborder-border-primary dark:!border-Mborder-border-primary-dark bg-Mbackgrounds-bg-primary dark:bg-Mbackgrounds-bg-primary-dark rounded-xl w-full">
              <div className="flex items-center justify-between gap-2 mb-5">
                ...
                <div className="relative inline-block">
                  ...
                  <div
                    className={
                      "absolute right-0 w-[370px] shadow-[32px_32px_40px_rgba(35,35,35,0.06)] rounded-[12px] bg-Mbackgrounds-bg-primary dark:bg-Mbackgrounds-bg-primary-dark border !border-Mborder-border-primary dark:!border-Mborder-border-primary-dark grid grid-cols-1 gap-2 transition-all duration-300 " +
                      (ToogleFilter
                        ? "top-[110%]"
              ...
              <div className="grid grid-cols-1 gap-4 max-h-[700px] overflow-auto scrollCustom">
                      ...
                      >
                        <div className="flex items-center gap-2 md:col-span-2">
                          ...
                          <div className="">
                            ...
                            <p className="md:hidden text__12 text-Mtext-text-tertiary dark:text-Mtext-text-tertiary-dark">
