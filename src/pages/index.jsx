...
const Index = () => {
  ...
  return (
    <Fragment>
      <LayoutAuth title="FinDash" navbar={false} footer={false}>
        <div className="mb-10">
          <h4 className="font-semibold text__32 dark:text-white">
            Welcome to Findash
          </h4>
        </div>
        ...
        <div className="text-right mb-6">
          <Link
            href="/reset-password"
            className="font-medium text__14 text-Mbrand-brand-primary "
          >
            Forgot Password ?
          </Link>
        </div>
        ...
        <div className="text-center">
          ...
          <div className="text-center mt-4">
            <p className="text__14 font-medium text-Mtext-text-tertiary">
              ...
              <Link class="text-Mbrand-brand-primary text__16 font-semibold" href="/register">
                Register
              </Link>
            </p>
          </div>
