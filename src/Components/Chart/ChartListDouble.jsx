...
const ChartListDouble = () => {
  const [data, setData] = useState({
    series: [
      ...
      {
        name: "Expenses",
        data: [7000, 45000, 60000, 70000, 39000, 66000, 70000, 81000, 188000],
      },
    ],
    options: {
      chart: {
      ...
      colors: ["#007AFF", "#ecf1f6"],
      markers: {
        colors: "#007AFF", // Default color
      },
      grid: {
        show: true,
        strokeDashArray: 4,
...
export default ChartListDouble;
